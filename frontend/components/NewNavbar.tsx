...
export function NewNavbar() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#fdf6ef] border-b border-gray-200 shadow-sm">
        {/* Content container */}
          ...
          <div className="flex items-center justify-between h-16 lg:h-20 px-4 lg:px-6 xl:px-8">
            ...
            <div className="flex items-center flex-shrink-0">
              <Link href="/" className="flex items-center gap-2 group">
                ...
                <span className="text-lg lg:text-xl font-bold text-red-700 tracking-wide group-hover:text-red-800 transition-colors">
                  Yến Sào Kim Sang
                </span>
              </Link>
            </div>
              ...
              <div className="hidden md:flex items-center">
                <form className="relative" onSubmit={(e) => { e.preventDefault(); }}>
                  <input
                    ...
                    className="w-64 lg:w-80 pl-4 pr-10 py-2 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                  />
                  <button
                    type="submit"
