  ...
  return (
    <div className="flex flex-col min-h-screen bg-white items-center justify-center py-12 px-2">
      <div className="max-w-md w-full mx-auto bg-white rounded-xl shadow-lg p-8 flex flex-col items-center animate-fade-in">
        ...
        <div className="mb-6">
          <svg
            className="w-16 h-16 text-green-500 animate-bounce-in"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
        ...
        <div className="w-full mb-6">
          <div className="flex flex-col gap-1 text-sm text-gray-700">
            <div>
              <span className="font-medium">Name:</span> (mock) Nguyễn Văn A
            </div>
            <div>
              <span className="font-medium">Address:</span> (mock) 123 Đường
              ABC, Quận 1, TP.HCM
            </div>
            <div>
              <span className="font-medium">Total Paid:</span>{' '}
              <span className="text-red-700 font-bold">2.500.000 ₫</span>
            </div>
          </div>
        </div>
