      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative">
            <ScaleInSection className="relative w-full max-w-2xl mx-auto">
              <Image
            ...
            <SlideUpSection className="mt-6 sm:mt-8" delay={0.3}>
              <Link
                href="/products"
                className="inline-block bg-[#a10000] text-white font-bold px-8 py-3 rounded-full shadow-lg hover:bg-red-800 transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
                Khám Phá Ngay
              </Link>
            </SlideUpSection>
